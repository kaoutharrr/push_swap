...
#    Updated: 2023/03/05 14:56:34 by kkouaz           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_B =  checker.c  linked_lists.c instructions.c  parsing.c push_swap.c tools.c libft/ft_atoi.c  join.c libft/ft_split.c libft/ft_substr.c libft/ft_strdup.c libft/ft_strlen.c  \
	libft/ft_isdigit.c sorting.c norm.c get_next_line/get_next_line.c get_next_line/get_next_line_utils.c main_bonus.c
OBJ = $(SRC:.c=.o)
OBJ_B =$(SRC_B:.c=.o)
